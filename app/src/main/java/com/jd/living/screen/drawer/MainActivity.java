...
import com.jd.living.screen.history.HistoryList_;
import com.jd.living.screen.search.Favorites_;
import com.jd.living.screen.search.SearchMain;
import com.jd.living.screen.search.SearchMain_;
import com.jd.living.screen.settings.PreferenceFragment.OnPreferenceAttachedListener;
import com.jd.living.screen.settings.SettingsPreferenceFragment_;
    ...
    public void onUpdate(List<Listing> result) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                } else if (currentPosition == 2 && searchStarted) {
                    currentPosition = 1;
                    navigationFragment.onUpdate(currentPosition);
                }
